...
async function loadPantry() {
    ...
    try {
        ...
        let html = '<table>';
        html += '<thead><tr>';
        html += '<th>Name</th><th>Category</th><th>Quantity</th><th>Location</th><th>Urgency</th>';
        html += '</tr></thead><tbody>';
        ...
        pantrySection.innerHTML = '<h2>Pantry Inventory</h2><div class="error">Error loading pantry data</div>';
...
async function loadRecipes() {
    ...
    recipesSection.innerHTML = '<h2>Recipes</h2><p>Recipe browser coming soon...</p>';
}

// Load meal plan
async function loadMealPlan() {
    const mealsSection = document.getElementById('meals');
    mealsSection.innerHTML = '<h2>This Week\'s Meal Plan</h2><p>Meal plan viewer coming soon...</p>';
}
...
async function loadShoppingList() {
    ...
    try {
        ...
        const html = '<pre style="white-space: pre-wrap; font-family: inherit;">' + text + '</pre>';
        shoppingSection.innerHTML = '<h2>Shopping List</h2>' + html;
        
    } catch (error) {
        shoppingSection.innerHTML = '<h2>Shopping List</h2><div class="error">No shopping list found</div>';
