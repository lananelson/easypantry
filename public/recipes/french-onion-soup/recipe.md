...
3. Add fish sauce, if using, and cider vinegar and season with salt and pepper. Discard thyme stems and bay leaf.
...
- Yellow onions are the best all-purpose choice, but a mix of yellow, sweet (e.g. Vidalia), and red onions plus shallots gives even more complex flavor.
- Caramelize slowly in butter to a rich golden brown, but not so dark it turns bitter.
- Chicken stock is usually better than store-bought beef stock here; fish sauce, cider vinegar, and sherry add depth.

## References

- Source: Clipping saved in Evernote (2016); links to Serious Eats' chicken stock recipe
